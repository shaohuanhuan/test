...
var Render = function () {
  ...
  _createClass(Render, [{
    ...
    value: function renderDom() {
      ...
      try {
        for (var _iterator = this.JSON.objects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var opt = _step.value;
          ...
          if (opt.type === 'rect') {
            ...
            div.css(style);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.container).append(div);
          }
          if (opt.type === 'i-text') {
            var _style = {
              position: 'absolute',
            ...
            var p = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<p>' + opt.text + '</p>');
            p.css(_style);
            // console.log($(this.container))
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.container).append(p);
          }
        }
      } catch (err) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_render__ = __webpack_require__(0);
/**
 * @author monkeywang
 * Date: 17/3/27
 */
...
// let hello = new Hello()
// hello.say()
var render = new __WEBPACK_IMPORTED_MODULE_0__common_render__["a" /* Render */](jsonHtml, '.container');
render.renderDom();
...
var SimpleCache = __webpack_require__(1);
