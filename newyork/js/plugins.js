...
function(a) {
    ...
    a.fn.scrollsnap = function(c) {
        ...
        c),
        e = "x" === d.direction ? "Left": "Top";
        return this.each(function() {
            var c = this,
            f = a(c);
            if (void 0 !== c["scroll" + e]) f.css("position", "relative"),
            f.bind("scrollstop", {
                latency: d.latency
            },
            function() {
                var h = null,
                i = d.proximity + 1;
                if (f.find(d.snaps).each(function() {
                    var a = this,
                    b = Math.abs(a["offset" + e] + d.offset - c["scroll" + e]);
                    b <= d.proximity && i > b && (h = a, i = b)
                }), h) {
                    var j = h["offset" + e] + d.offset,
                    k = {};
                    k["scroll" + e] = j,
                    f["scroll" + e]() != j && f.animate(k, d.duration, d.easing, b(function() {
                        var b = a(h);
                        d.onSnap && d.onSnap(b),
                        b.trigger(d.onSnapEvent)
                    },
                    d.onSnapWait))
                }
            });
            else if (c.defaultView) {
                var g = function() {
                    var h = null,
                    i = d.proximity + 1;
                    if (f.find(d.snaps).each(function() {
                        var b = this,
                        f = a(b),
                        g = Math.abs(f.offset()[e.toLowerCase()] + d.offset - c.defaultView["scroll" + d.direction.toUpperCase()]);
                        g <= d.proximity && i > g && (h = b, i = g)
                    }), h) {
                        var j = a(h),
                        k = j.offset()[e.toLowerCase()] + d.offset,
                        l = {};
                        l["scroll" + e] = k,
                        f["scroll" + e]() != k && a("html, body").animate(l, d.duration, d.easing, b(function() {
                            d.onSnap && d.onSnap(j),
                            j.trigger(d.onSnapEvent)
                        },
                        d.onSnapWait))
                    }
                };
...
!
function(a) {
    var b = a.event.dispatch || a.event.handle,
    c = a.event.special,
    d = "D" + +new Date,
    e = "D" + ( + new Date + 1);
    c.scrollstart = {
        setup: function(e) {
            ...
            h = function(a) {
                var c = this,
                d = arguments;
                g ? clearTimeout(g) : (a.type = "scrollstart", b.apply(c, d)),
...
(function(e, r, p) {
    var l = {
        ...
        erase: function() {
            return this.each(function() {
                ...
                for (i = 0; i < d.setTimeOutHandler.length; i++) clearTimeout(d.setTimeOutHandler[i]);
                d.playhead = 0;
                d.count = 0;
                d.complete = !1
            })
        ...
        stamp: function() {
            return this.each(function() {
                ...
                b = function() {
                    ...
                    for (i = 0; i < a.svgData.length; i++) a.paper.path(a.svgData[i].path).attr(m(a, a.svgData[i]))
                };
                null === a.delay ? b() : setTimeout(b, a.delay)
            })
        }
    ...
    m = function(c, a) {
        return {
            stroke: a.strokeColor ? a.strokeColor: c.strokeColor,
            "fill-opacity": 0,
            "stroke-dasharray": a.strokeDash ? a.strokeDash: c.strokeDash,
            "stroke-opacity": a.strokeOpacity ? a.strokeOpacity: c.strokeOpacity,
            "stroke-width": a.strokeWidth ? a.strokeWidth: c.strokeWidth,
            "stroke-linecap": a.strokeCap ? a.strokeCap: c.strokeCap,
    ...
    n = function(c) {
        ...
        k = c.callback,
        g;
        g = "string" == typeof b ? a.path(b).attr({
            stroke: "none",
            fill: "none"
        }) : b;
        var l = a.path(g.getSubpath(0, 1)).attr(f),
        m = g.getTotalLength(g);
        g.getPointAtLength(0);
        var n = (new Date).getTime(),
        q = setInterval(function() {
            var a = (new Date).getTime() - n,
            b = g.getSubpath(0, a / e * m);
            f.path = b;
            l.animate(f, 25);
    ...
    e.fn.lazylinepainter = function(c) {
        ...
        if ("object" === typeof c || !c) return l.init.apply(this, arguments)
    }
})(jQuery, window);